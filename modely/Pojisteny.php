...
// Vlastnosti objektu
    ...
    public string $predvolba;       // Předvolba
    ...
    public function __construct(int $id, string $jmeno, string $prijmeni, string $predvolba, string $telefon, string $datum_narozeni) {
        $this->id = $id;
        $this->jmeno = $jmeno;
    ...
    public function __toString(): string {
        return "$this->jmeno, $this->prijmeni, $this->predvolba, tel: $this->telefon, věk: $this->datum_narozeni";
    }
}
